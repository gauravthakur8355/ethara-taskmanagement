...
exports.healthLimiter = exports.authLimiter = exports.generalLimiter = void 0;
...
exports.generalLimiter = (0, express_rate_limit_1.default)({
    ...
    max: env_1.env.IS_PRODUCTION ? 100 : 1000, // way more relaxed in dev (dont want to rate-limit ourselves while testing lol)
...
exports.authLimiter = (0, express_rate_limit_1.default)({
    ...
    max: env_1.env.IS_PRODUCTION ? 20 : 500, // very strict in prod
    ...
    handler: (_req, res, _next, options) => {
        ...
        logger_1.logger.warn("Auth rate limit exceeded — possible brute force", {
            ip: _req.ip,
            path: _req.path,
            limiter: "auth",
        });
...
exports.healthLimiter = (0, express_rate_limit_1.default)({
